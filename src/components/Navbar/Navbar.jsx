    ...
    return (
        <div className={styles.Navbar}>
            ...
            <div className={`${styles.right}`}>
                <div className={`d-flex d-lg-none ${styles.browse}`}>
                    <IoCompassOutline size={"20px"} />
                    <div>Browse</div>
                    <IoIosArrowDown size={"15px"} />
                </div>
                <div className={`d-none d-lg-flex ${styles.searchwrapper}`}>
                    <svg
                        width='17'
                        viewBox='0 0 28 28'
                        fill='none'
                ...
                <div
                    className={`d-none d-lg-flex ${styles.noti}`}
                    title='Notifications'>
                    <svg
                        width='20'
                        height='20'
                    ...
                    <div className={styles.noticount}>0</div>
                </div>
                <div
                    className={`d-none d-lg-flex ${styles.profile}`}
                    title='Divyam Sharma'>
                    <RxAvatar size={"25px"} />
                </div>
                <div className={`d-none d-lg-flex ${styles.pointswrapper}`}>
                    <svg
                        width='25'
                        height='25'
                        viewBox='0 0 26 25'
                    ...
                    <div className={styles.text}>244</div>
                </div>
